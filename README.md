# Patch Notes
If you're reading this, then you must have received a binary alongside these notes. This binary is patched to work without asking for permission or sending data from/to any web service. Other than that, everything is perfectly intact.
